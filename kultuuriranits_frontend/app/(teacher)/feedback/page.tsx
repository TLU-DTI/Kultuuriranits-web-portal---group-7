            ...
            <div className="flex items-center gap-3 mb-8 pb-4 border-b border-gray-100">
                ...
                <div>
                    ...
                    <p className="text-sm font-medium text-gray-500 mt-0.5">
                        Siin on kõik sinu poolt kultuuriprogrammidele jäetud arvustused ja
                        hinnangud.
                    </p>
                </div>
            </div>
                        ...
                        >
                            <div>
                                ...
                                {fb.program?.organization?.name && (
                                    <div className="inline-flex items-center gap-2 mb-3 bg-blue-50 border border-blue-100 text-blue-600 px-3 py-1.5 rounded-xl text-xs font-extrabold">
